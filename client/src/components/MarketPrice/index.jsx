...
import { Card, CardContent, CardHeader, CardTitle } from "../YieldPrediction/Card";
import { Progress } from "../YieldPrediction/Progress";
import { Badge } from "../YieldPrediction/Badge";
...
const MarketPrice = () => {
    ...
    const goToPredictPage = (id, region) => {
        navigate('/market-predict/', {
            state: {
                crop: id,
                area: farmer.farmSize * 0.404686,
                location: region
            }
        });
    };
